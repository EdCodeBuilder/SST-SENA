...
?>
<script src="../../js/seguridad/usuarioRol.js"></script>
...
<body onload="Enviar('CONSULTAR',null)">
    <form name="fmrUsuarioRol" id="frmUsuarioRol">
            ...
            <div class="container form-group">
                <div class="row">
                    <div class="col-12 col-sm-4">
                        <input type="hidden" name="hidIdUsuarioRol" id="hidIdUsuarioRol" value="">
                        <input type="hidden" name="hidIdUsuario" id="hidIdUsuario" value="">
                        <label class="col-form-label">Usuario</label>
                        <input type="text" name="txtUsuario" id="txtUsuario" value="" placeholder=" Usuario" class="caja form-control">
                    </div>
                    <div class="col-12 col-sm-4">
