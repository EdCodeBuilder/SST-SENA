            ...
            <div class="container form-group">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-3">
                        ...
                        <input type="text" name="txtEtiqueta" id="txtEtiqueta" value="" class="caja form-control" placeholder="Etiqueta">
                    </div>
                    <div class="col-12 col-sm-3">
                        <label class="col-form-label">Ubicación</label>
                        <input type="text" name="txtUbicacion" id="txtUbicacion" value="" class="caja form-control" placeholder="Ubicación">
                    </div>
                    <div class="col-12 col-sm-3">
