            ...
            <div class="container form-group">
                <div class="row">
                    <div class="col-12 col-sm-3">
                        ...
                        <input type="text" name="txtNombre" id="txtNombre" value="" class="caja form-control" placeholder="Nombre">
                    </div>
                    <div class="col-12 col-sm-3">
                        <label class="col-form-label">Apellido</label>
                        <input type="text" name="txtApellido" id="txtApellido" value="" class="caja form-control" placeholder="Apellido">
                    </div>
                    <div class="col-12 col-sm-3">
